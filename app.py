...
취합한 뒤 화면에 보여주고 엑셀 파일로 다운로드할 수 있게 해주는 앱입니다.
...
st.set_page_config(page_title="소포수령증 PDF 취합기", page_icon="📦", layout="wide")

st.title("📦 소포수령증 PDF 취합기")
st.write(
    "PDF 파일들을 업로드하면 표를 자동으로 인식해서 하나로 취합해드립니다. "
    "결과를 화면에서 확인하고 엑셀 파일로 다운로드할 수 있어요."
)
